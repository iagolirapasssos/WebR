...
public class WebR extends AndroidNonvisibleComponent {
     ...
     */
    @SimpleFunction(description = "Sets the request headers.")
     ...
     */
    @SimpleFunction(description = "Sets the request data.")
    ...
    public void RequestCompleted(String tag, String response) {
        EventDispatcher.dispatchEvent(this, "RequestCompleted", tag, response);
    }

    @SimpleEvent(description = "Event triggered when a web request fails.")
    public void RequestFailed(String tag, String error) {
        EventDispatcher.dispatchEvent(this, "RequestFailed", tag, error);
    }
